...
app.MapGet("/", async Task<Results<Ok<OkResult>, BadRequest<BadRequestResult>>> () =>
{
    ...
    try
    {
        var response = await httpClient.GetAsync(
            "https://webadapters.channeladvisor.com/CSEAdapter/Default.aspx?pid=WZP^^F^SAnHKt5*-U%5beC2TQjvwI_%26%2b\"`%5bJ_Q)nHHHc%26%5c%24KaL3QV%3duI%3d6(*%23%5bbIdQQnGy%40_WaUecw%5dRTlHJ");
